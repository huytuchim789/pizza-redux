...
const availableTypesValue = ['Hiện đại', 'truyên thống']

const ProductBlock = React.memo(
  ({
    item: { id, name, sizes, imageUrl, price, types },
    index,
    onClickAddPizza,
    valueCartCount,
  }) => {
